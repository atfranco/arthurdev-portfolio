...
export default function Sobre() {
    ...
    return(
        <div className='tela'>
            ...
            <Espacador />
            <p className='animado-texto'>Busco oferecer aos meus clientes a aplicações modernas de alta performance aliada aos conceitos de Design e User Experience UI/UX</p>
            <Espacador />

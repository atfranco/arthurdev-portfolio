...
const handler = (_req: NextApiRequest, res: NextApiResponse) => {
  try {
    res.status(200).json([
    {
        "id":"01",
        "nome":"Layout Eventos",
        "descricao":"Site institucional, criamos ele em 2018 e passou por uma renovação de layout e funções, está em sua segunda versão com um layout moderno junto de um gerenciamento/atualização dos projeto por parte de postagens do cliente",
        "tipo":"Institucional",
    ...
    },
    {
        "id":"04",
        "nome":"PlanoACCD",
        "descricao":"Site elaborado para marcar uma nova fase do escritório focado na era digital com chatbot e portal do cliente.",
        "tipo":"Institucional",
